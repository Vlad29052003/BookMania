...
public class RegistrationService {
     ...
     */
    public AppUser registerUser(NetId netId, String email, Password password, Authority authority) throws Exception {
        ...
        if (checkNetIdIsUnique(netId)) {
            ...
            // Create new account
            AppUser user = new AppUser(netId, email, hashedPassword, authority);
