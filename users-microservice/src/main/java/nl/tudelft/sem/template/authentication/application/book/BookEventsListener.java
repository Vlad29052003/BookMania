...
public class BookEventsListener {
    ...
    public void onBookWasCreated(BookWasCreatedEvent event) {
        ...
        try {
            HttpRequest request = HttpRequest.newBuilder()
                    ...
                    .POST(HttpRequest.BodyPublishers.ofString(mapper.writeValueAsString(new ReviewBookModel(book))))
                    .build();
    ...
    public void onBookWasEdited(BookWasEditedEvent event) {
        ...
        try {
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create(BOOKSHELF_URI))
                    .PUT(HttpRequest.BodyPublishers.ofString(mapper.writeValueAsString(new ReviewBookModel(book))))
                    .build();
